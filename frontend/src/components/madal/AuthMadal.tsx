      ...
      <Dialog as="div" className="relative z-[100]" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="relative w-full max-w-[95%] sm:max-w-[520px] md:max-w-[700px] lg:max-w-[920px] transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all flex items-center md:h-[420px]">
