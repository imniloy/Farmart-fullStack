            ...
            <div className="overflow-hidden">
              ...
              <div className="grid gap-4 mb-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="flex h-full cursor-pointer">
                  <div className="flex items-center border border-gray-200 bg-brand-color w-full rounded-lg p-4">
                    ...
                    <div>
                      <h5 className="leading-none mb-2 text-base font-medium font-inter text-gray-700">
                        Total Order
                      </h5>
                      <p className="text-xl font-bold font-inter leading-none text-gray-800">
                        151
                      </p>
                    </div>
                  </div>
