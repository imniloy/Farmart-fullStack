      ...
      <div className="w-fit sm:w-[500px] md:w-[520px] lg:w-[600px] mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="block text-center text-base font-inter text-gray-600 my-2">
            Sorry! This Product is not found! Please try again later.
          </p>
          ...
          <div
            ...
            className="bg-emerald-500 w-fit mx-auto py-3 sm:py-4 px-10 sm:px-12 rounded-lg font-semibold mt-4 sm:mt-6 text-sm hover:bg-emerald-600 text-gray-100"
          >
            Back to Home
          </div>
        </div>
